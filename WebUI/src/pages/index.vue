    ...
    <v-row>
      ...
      >
        <ConversationCard
          ...
          @overlay-action="(k) => handleOverlayAction(k, conversation.id)"
        />
      </v-col>
    </v-row>
...
<script lang="ts" setup>
  ...
  async function handleOverlayAction (actionKey: string, conversationId: string) {
    if (actionKey === 'del') {
