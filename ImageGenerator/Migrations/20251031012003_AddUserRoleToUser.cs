    ...
    public partial class AddUserRoleToUser : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "CreatedAt", "Credits", "InvitedById", "IsDeleted", "LastCreditClaimedAt", "Password", "Role", "Salt", "Username" },
                values: new object[,]
                {
                    { new Guid("00000000-0000-0000-0000-000000000001"), new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), 100m, null, false, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "C0FC41A30BEB7C221BB9CB69DF665943ED9F425211FFB8EFA9B5091F7C0BC7F1", 3, "admin-salt-123", "admin" },
                    { new Guid("00000000-0000-0000-0000-000000000002"), new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), 100m, null, false, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "F64FFCA00480CB9155C0D068E8B11077291CAABF38DF01E130A8941F8E591C1A", 0, "tester-salt-456", "tester" }
                });

            migrationBuilder.InsertData(
                table: "Conversations",
                columns: new[] { "Id", "CreatedAt", "IsDeleted", "UpdatedAt", "UserId" },
                values: new object[] { new Guid("00000000-0000-0000-0000-000000000005"), new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), false, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), new Guid("00000000-0000-0000-0000-000000000001") });
