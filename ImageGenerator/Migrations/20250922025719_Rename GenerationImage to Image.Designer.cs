...
namespace ImageGenerator.Migrations
{
    ...
    [Migration("20250922025719_Rename GenerationImage to Image")]
    partial class RenameGenerationImagetoImage
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ImageGenerator.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Salt = "admin-salt-123",
                            SubscriptionExpiration = new DateTime(2034, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            Username = "admin"
                        });
                });
