...
public interface IPresetService
{
    ...
    Task<PagedList<Preset, PresetDto>> GetPresetsAsync(PaginationBaseDto param);
    ...
    Task<PresetDetailedDto?> GetPresetByIdAsync(Guid id);
    ...
    Task<PresetDetailedDto> CreatePresetAsync(CreatePresetDto dto);
    ...
    Task<IEnumerable<PresetDto>> GetMyPresetsAsync();
}